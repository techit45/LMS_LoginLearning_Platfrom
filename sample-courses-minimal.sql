-- ===================================
-- เพิ่มข้อมูลคอร์สตัวอย่างใน Supabase (Minimal Version)
-- ลบเฉพาะ tables ที่มีอยู่จริง
-- ===================================

-- ลบข้อมูลเฉพาะที่มีใน database (ตรวจสอบก่อนลบ)
DO $$
BEGIN
    -- ลบข้อมูลที่เกี่ยวข้องตามลำดับ (หาก table มีอยู่)
...
-- เพิ่มเนื้อหาคอร์สตัวอย่าง (หาก table course_content มีอยู่)
DO $$
BEGIN
    IF EXISTS (SELECT FROM information_schema.tables WHERE table_name = 'course_content') THEN
