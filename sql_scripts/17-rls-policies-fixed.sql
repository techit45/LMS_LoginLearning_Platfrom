-- ==========================================
-- TIME TRACKING SYSTEM - RLS POLICIES (SUPABASE COMPATIBLE)
-- Login Learning Platform - Security Implementation
-- Fixed for Supabase PostgreSQL version compatibility
-- ==========================================
...
DROP POLICY IF EXISTS "time_policies_admin_all_access" ON time_policies;
DROP POLICY IF EXISTS "time_policies_read_company_policies" ON time_policies;
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "work_schedules_read_own" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_read_team" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_admin_read_all" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_create_own" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_create_team" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_update_policy" ON work_schedules;
DROP POLICY IF EXISTS "work_schedules_delete_admin_only" ON work_schedules;
...
DROP POLICY IF EXISTS "time_entries_read_team" ON time_entries;
DROP POLICY IF EXISTS "time_entries_admin_read_all" ON time_entries;
...
DROP POLICY IF EXISTS "time_entries_delete_admin_only" ON time_entries;
...
DROP POLICY IF EXISTS "leave_requests_read_team" ON leave_requests;
DROP POLICY IF EXISTS "leave_requests_admin_read_all" ON leave_requests;
DROP POLICY IF EXISTS "leave_requests_create_own" ON leave_requests;
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "attendance_summary_read_own" ON attendance_summary;
DROP POLICY IF EXISTS "attendance_summary_read_team" ON attendance_summary;
DROP POLICY IF EXISTS "attendance_summary_admin_read_all" ON attendance_summary;
DROP POLICY IF EXISTS "attendance_summary_system_create" ON attendance_summary;
DROP POLICY IF EXISTS "attendance_summary_system_update" ON attendance_summary;
DROP POLICY IF EXISTS "attendance_summary_delete_admin_only" ON attendance_summary;
...
-- Drop existing policies if they exist
DROP POLICY IF EXISTS "audit_admin_read_only" ON time_tracking_audit;
DROP POLICY IF EXISTS "audit_system_insert" ON time_tracking_audit;
...
-- ==========================================
-- VERIFICATION QUERIES (SUPABASE COMPATIBLE)
-- ==========================================
...
-- Verify RLS is enabled (removed forcerowsecurity column for Supabase compatibility)
...
SELECT 'Time Tracking RLS Policies Created Successfully!' as message;