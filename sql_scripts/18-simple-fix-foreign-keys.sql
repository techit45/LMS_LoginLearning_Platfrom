-- ==========================================
-- SIMPLE FIX FOR TIME TRACKING FOREIGN KEYS
...
COMMENT ON TABLE time_entries IS 'Time tracking entries with user relationships - Updated ' || NOW();
COMMENT ON TABLE leave_requests IS 'Leave requests with user relationships - Updated ' || NOW();
COMMENT ON TABLE work_schedules IS 'Work schedules with user relationships - Updated ' || NOW();
COMMENT ON TABLE attendance_summary IS 'Attendance summaries with user relationships - Updated ' || NOW();
