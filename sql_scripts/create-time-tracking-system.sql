-- ==========================================
-- TIME TRACKING SYSTEM MIGRATION SCRIPT
...
-- ==========================================
-- 1. TIME TRACKING POLICIES TABLE
-- ==========================================
...
-- ==========================================
-- 5. ATTENDANCE SUMMARY TABLE (Performance Optimization)
-- ==========================================
...
-- ==========================================
-- UPDATE USER_PROFILES TABLE FOR TIME TRACKING
-- ==========================================
...
-- Create sample work schedules for different user types
...
SELECT 
    ...
    '08:00', '17:00',  -- Friday
    '09:00', '15:00',  -- Saturday (weekend classes)
    false,             -- Sunday off
    'Main Campus',
    20.0,              -- 20 hours teaching
    20.0               -- 20 hours admin
FROM user_profiles 
WHERE role IN ('instructor', 'admin') 
AND NOT EXISTS (
    SELECT 1 FROM work_schedules ws 
    WHERE ws.user_id = user_profiles.user_id
);
...
-- AND table_name LIKE '%time%' OR table_name LIKE '%leave%' OR table_name LIKE '%work%' OR table_name LIKE '%attendance%'
-- ORDER BY table_name;
