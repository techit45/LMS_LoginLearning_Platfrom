...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      if (error) {
        // ถ้าไม่มีตาราง contact_messages ให้แสดงข้อความว่าส่งสำเร็จแทน
        if (error.code === "42P01") {
          toast({
      ...
      toast({
        ...
        description:
          "ไม่สามารถส่งข้อความได้ กรุณาลองอีกครั้งในภายหลัง หรือติดต่อผ่านช่องทางอื่น",
        variant: "destructive",
      });
    } finally {
      setLoading(false);
  ...
  return (
    ...
    >
      <Helmet>
        ...
        <meta
          name="description"
          content="ติดต่อ Login Learning เพื่อสอบถามข้อมูลคอร์สเรียน บริการ หรือขอคำปรึกษาด้านวิศวกรรม"
        />
      </Helmet>
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <Input
                  ...
                  className="text-black bg-white/90 focus:bg-white"
                  required
                />
              </div>
              <div>
              ...
              <div>
                ...
                <Input
                  ...
                  placeholder="เช่น สอบถามเกี่ยวกับคอร์ส Arduino"
                  className="text-black bg-white/90 focus:bg-white"
                  required
                />
              </div>
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    {companyInfo.contacts.map((contact) => (
                      <p key={contact.name} className="text-gray-700">
                ...
                <div className="flex items-start space-x-3">
                  ...
                  <div>
                    ...
                    <a
                      ...
                      className="text-gray-700 hover:text-teal-600 transition-colors underline"
                    >
