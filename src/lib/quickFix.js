    ...
    courses: [
      {
        ...
        price: 0,
        duration_hours: 10,
        thumbnail_url: 'https://via.placeholder.com/400x300/3b82f6/ffffff?text=React+Course',
      ...
      },
      {
        ...
        price: 1500,
        duration_hours: 15,
        thumbnail_url: 'https://via.placeholder.com/400x300/10b981/ffffff?text=Chemical+Engineering',
        instructor_name: 'ครูผู้สอน',
        enrolled_count: 18,
        rating: 4.3,
        is_active: true,
      ...
      },
      {
        ...
        price: 2000,
        duration_hours: 20,
        thumbnail_url: 'https://via.placeholder.com/400x300/f59e0b/ffffff?text=IoT+Course',
        instructor_name: 'ครูผู้สอน',
        enrolled_count: 32,
        rating: 4.7,
        is_active: true,
    ...
    projects: [
      {
        ...
        cover_image_url: 'https://via.placeholder.com/400x300/06b6d4/ffffff?text=IoT+Project',
        created_by: 'นักเรียน',
        view_count: 156,
        like_count: 23,
      ...
      },
      {
        ...
        cover_image_url: 'https://via.placeholder.com/400x300/8b5cf6/ffffff?text=AI+Project',
        created_by: 'นักเรียน',
        view_count: 234,
        like_count: 45,
      ...
      },
      {
        ...
        difficulty_level: 'intermediate',
        cover_image_url: 'https://via.placeholder.com/400x300/10b981/ffffff?text=Hydroponic+Farm',
        created_by: 'นักเรียน',
        view_count: 189,
        like_count: 28,
